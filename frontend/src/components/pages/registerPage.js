...
const Register = () => {
  ...
  let backgroundStyling = {
    background: bgColor,
    backgroundImage:
      "url(https://bdc2020.o0bc.com/wp-content/uploads/2019/09/orangelinecar-768x432.jpeg?width=800)", // Add your image URL here
      ...
      <section className="vh-100">
        <div className="container-fluid h-custom vh-100">
          <div
            ...
            style={{ backgroundColor: "#0c3353" }}
          >
            <div
              className="col-md-8 col-lg-6 col-xl-4  p-4 rounded"
              ...
              <Form>
                ...
                <Form.Group className="mb-3" controlId="formBasicPassword">
                  ...
                  <Form.Control
                    ...
                    onChange={handleChange}
                  />
                  <Form.Text className="text-muted" style={{ color: "gray" }}>

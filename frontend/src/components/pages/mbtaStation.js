      ...
      <Card.Body>
        <Row className="justify-content-center">
          <Col xs={18} sm={16} md={12} lg={15} style={{ padding: "1%" }}>
            <Card
              className="mb-1 text-center rounded shadow "
          ...
          <Container className="d-flex justify-content-center align-items-center mb-2">
            <div className="d-flex flex-wrap justify-content-center">
              <button
                className={`text-center btn me-2 mb-2 ${
              ...
              {!filterActive && (
                <>
                  <button
                    className={`btn me-2 text-white mb-2 ${
                      lineFilter === "" ? "active" : ""
                    }`}
                    style={{ backgroundColor: "#165c96" }}
                        ...
                        >
                          ...
                          <Card.Text className="mx-4 text-start border-0 bg-transparent">
                            ...
                            <Card.Text className="d-flex mt-4 justify-content-center align-items-center">
                              <span className="ms-4">
                                {station.attributes.wheelchair_boarding ===
                                1 ? (

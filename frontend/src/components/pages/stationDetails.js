...
function StationDetails({ recommendCount, notRecommendedCount }) {
  ...
  const submitReview = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${process.env.REACT_APP_BACKEND_SERVER_URI}/userReview/reviews`,
        {
  ...
  const deleteReview = async (e, reviewId) => {
    ...
    try {
      ...
      await axios.delete(
        `${process.env.REACT_APP_BACKEND_SERVER_URI}/userReview/deleteReviews/${reviewId}`
      );
  ...
  const handleVote = async (reviewId, voteType, stationId) => {
    try {
      await axios.post(
        `${process.env.REACT_APP_BACKEND_SERVER_URI}/reviewRating/rateReview/${reviewId}`,
        {
          voteType,
          stationId,
          ...ratingData,
